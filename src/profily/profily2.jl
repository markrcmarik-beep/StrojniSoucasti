...
#   "Jp" - polární moment setrvačnosti [mm^4]
#   "Jt" - torzní moment [mm^3] (pro kruhové průřezy) - zatím není implementováno
...
function profily(inputStr::AbstractString, args...; natoceni = 0)
    ...
    # -----------------------------------------------------------
    # 4) Pokud jsou zadány vlastnosti (A, Ix, Iy, J…) nebo hodnoty pro natočení, řeší profilyvlcn nebo přidá natočení
    # -----------------------------------------------------------
    vlastnosti = ["A", "I", "Ix", "Iy", "Ixy", "Imin", "Imax", "Wo", "Wx", "Wy", "Jp", "Jt", "J", "Wk", "Wt"]
