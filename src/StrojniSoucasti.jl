...
include("profily/profilyIminmax4natoceni.jl") # minimální a maximální kvadratický moment pro dané natočení profilu z jeho kvadratických momentů Ix, Iy a Ixy
