...
###############################################################
## Popis funkce:
# Z bodu A vede polopřímky pod úhly (alfa, beta). Vypočítá 
# souřadnice okrajových bodů B (alfa), C (beta) pro kružnici 
# o poloměru r, která je osazena tečně do vnitřního zaoblení 
# mezi těmito polopřímkami.
