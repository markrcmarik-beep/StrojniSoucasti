...
dims3 = profily("TR4HR 50x30x5", "S", "Ix") # rozměry + vlastnosti
...
@test dims3[:t] == 5u"mm"
@test dims3[:R] == 0u"mm"
dims3 = profily("TR4HR 50x30x5", "S", "Ix", natoceni=0) # rozměry + vlastnosti

dims3 = profily("TR4HR 50x30x5") # pouze rozměry
@test dims3[:info] == "TR4HR"
@test dims3[:a] == 50u"mm"
@test dims3[:b] == 30u"mm"
@test dims3[:t] == 5u"mm"
