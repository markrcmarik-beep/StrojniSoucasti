...
body_A1 = StrojniSoucasti.body_I_CSN425550("I80", "stred", natoceni=90*pi/180)
...
body_A2 = StrojniSoucasti.body_IPE_CSN425553("IPE80", "stred", natoceni=90*pi/180)
...
Jp2 = StrojniSoucasti.polygon2polarnimoment(body_A2)
println("Jp = ", Jp2, "mm^4")
Wk2 = StrojniSoucasti.polygon2prurezovymodulkrut(body_A2)
println("Wk = ", Wk2, "mm^3")
...
body_A3 = StrojniSoucasti.body_TR4HR_CSN425720("TR4HR40x4", "stred", natoceni=45*pi/180)
...
Jp3 = StrojniSoucasti.polygon2polarnimoment(body_A3)
println("Jp = ", Jp3, "mm^4")
Wk3 = StrojniSoucasti.polygon2prurezovymodulkrut(body_A3)
println("Wk = ", Wk3, "mm^3")
