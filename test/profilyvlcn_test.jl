...
Ix, Ixtext = StrojniSoucasti.profilyvlcn(plocha, :Ix, natoceni=pi) # Výpočet Kvadratický moment v ohybu
...
S2, Stext2 = StrojniSoucasti.profilyvlcn(Prf2, :Ip) # Výpočet plochy
